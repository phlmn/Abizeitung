                ...
                <table class="table table-striped state">
					...
					<?php
						...
						<tr>
							...
							<td class="<?php echo ($row["birthday"]) 					? "existing" : "missing"?>"><?php echo ($row["birthday"]) ? $row["birthday"] : "-"; ?></td>
							<td class="<?php echo ($row["activated"]) 					? "existing" : "missing"?>"><?php echo ($row["activated"]) ? "Ja" : "-" ?></td>
